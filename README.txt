...
In this project, I was responsible for creating the High Scores system (src/com/example/cs252project/Highscores.java and mysql-java/ScoresServer.java) and handling some of the game logic (portions of src/com/example/cs252project/playingBoard.java), including alien movement speed and health, score, scaling of drawables based on screen size, and level progression. A teammate and myself attempted to add multiplayer, but ran out of time and scrapped the idea. 
